...
type DitherEffectVariant = "square" | "circle" | "triangle" | "diamond"
...
type DitherEffectProps = {
  ...
  edgeFade?: number
  noiseAmount?: number
  overlayVariant?: "center-fade" | "corner-fade" | "none"
}
...
const SHAPE_MAP: Record<DitherEffectVariant, number> = {
  square: 0,
  circle: 1,
  triangle: 2,
  diamond: 3,
...
export function DitherEffect({
  ...
  return (
    <div
      ...
      style={style}
      aria-label="Dither interactive background"
    >
      {overlayVariant === "center-fade" && (
        <div className="bg-gradient-center-fade pointer-events-none absolute inset-0 z-10" />
      )}
      {overlayVariant === "corner-fade" && (
        <div className="bg-gradient-corner-fade pointer-events-none absolute inset-0 z-10" />
      )}
    </div>
  )
}
