...
export const GitHubIcon = memo((props: SVGProps<SVGSVGElement>) => (
...
export const DiscordIcon = memo((props: SVGProps<SVGSVGElement>) => (
  <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
...
export const GoogleIcon = memo((props: SVGProps<SVGSVGElement>) => (
